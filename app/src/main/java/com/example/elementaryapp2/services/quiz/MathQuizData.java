...
public class MathQuizData {
    ...
    static int pink = Color.HSVToColor(255, new float[]{296, 0.99f, 0.99f});

    static {
        mathQuiz.add(new MathQuizQuestion(Color.RED, ShapeView.SHAPE_TRIANGLE, 3, 4, '+'));
        mathQuiz.add(new MathQuizQuestion(Color.BLUE, ShapeView.SHAPE_RECTANGLE, 6, 2, '+'));
        mathQuiz.add(new MathQuizQuestion(Color.GREEN, ShapeView.SHAPE_CIRCLE, 8, 1, '+'));
        mathQuiz.add(new MathQuizQuestion(Color.YELLOW, ShapeView.SHAPE_RECTANGLE, 6, 4, '-'));
        mathQuiz.add(new MathQuizQuestion(Color.MAGENTA, ShapeView.SHAPE_CIRCLE, 5, 3, '-'));
        mathQuiz.add(new MathQuizQuestion(pink, ShapeView.SHAPE_TRIANGLE, 3, 1, '-'));
        mathQuiz.add(new MathQuizQuestion(Color.YELLOW, ShapeView.SHAPE_SQUARE, 2, 1, 'x'));
        mathQuiz.add(new MathQuizQuestion(Color.BLACK, ShapeView.SHAPE_RECTANGLE, 3, 3, 'x'));
        mathQuiz.add(new MathQuizQuestion(Color.RED, ShapeView.SHAPE_CIRCLE, 9, 3, '/'));
        mathQuiz.add(new MathQuizQuestion(Color.YELLOW, ShapeView.SHAPE_SQUARE, 4, 2, '/'));
    ...
    public static List<ShapeBox> getAnswers(MathQuizQuestion question) {
        ...
        List<Integer> shapeList = Arrays.asList(ShapeView.SHAPE_SQUARE, ShapeView.SHAPE_CIRCLE, ShapeView.SHAPE_TRIANGLE, ShapeView.SHAPE_RECTANGLE);
        List<Integer> colorList = Arrays.asList(Color.BLUE, Color.RED, Color.GREEN, Color.YELLOW, Color.MAGENTA, pink, Color.BLACK);
