...
public class AlertDialogUtil {
    private static AlertDialog alertDialogLoading, alertDialogQuiz, alertDialogPremium;
...
//            imageView.setImageResource(R.drawable.incorrect_animal_image);
    ...
    public static void ShowPremiumAlertDialog(Context context) {
        // Create a dialog builder
        AlertDialog.Builder builder = new AlertDialog.Builder(context, R.style.TransparentAlertDialog);

        // Inflate the custom layout
        View customLayout = LayoutInflater.from(context).inflate(R.layout.premium_dialog_layout, null);
        builder.setView(customLayout);
        ...
        Glide.with(context)
                .asGif()
                .load(R.drawable.premium_gif)
                .skipMemoryCache(true)
                .into(imageView);

        // Create and show the dialog
        alertDialogPremium = builder.create();
        alertDialogPremium.show();

        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Dismiss the dialog
                alertDialogPremium.dismiss();
            }
        });
    }
