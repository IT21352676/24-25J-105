...
public class RecycleViewAdapterLetters extends RecyclerView.Adapter<ViewHolderLetters>{
    ...
    public void onBindViewHolder(@NonNull ViewHolderLetters holder, int position) {
        ...
        if (letter.isLocked) {
            holder.cardView.setCardBackgroundColor(ContextCompat.getColor(holder.itemView.getContext(), R.color.btnBlack)); // Change the color as needed
            ...
            public void onClick(View v) {
                ...
                if (adapter.itemClickListener != null) {
                    ...
                    if (position != RecyclerView.NO_POSITION) {
                        Letter selectedLetter = adapter.list.get(position);
                        if (selectedLetter.isLocked) {
                            AlertDialogUtil.ShowPremiumAlertDialog(adapter.context);
                        } else {
