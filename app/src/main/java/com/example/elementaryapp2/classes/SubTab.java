...
public class SubTab extends Tab{
    ...
    public SubTab(int image, String header, String subText, String pageType, int bgClr, int btnBgClr, List<QuizActivityQuestion> faceActivityProblems, Integer tutorialResource) {
        super(image, header, subText, pageType, -1, bgClr, btnBgClr, null);
        this.faceActivityProblems = faceActivityProblems;
        this.tutorialResource = tutorialResource;
    }
}
