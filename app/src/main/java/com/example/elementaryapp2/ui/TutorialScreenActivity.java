...
public class TutorialScreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<QuizActivityQuestion> faceQuiz;
        ...
        if (type == 3) {
            faceQuiz = (List<QuizActivityQuestion>) getIntent().getSerializableExtra("quizData");
        } else {
            faceQuiz = null;
        }
        ...
        skipButton.setOnClickListener(v -> {
            if (type == 0) {
                ...
                Intent intent = new Intent(this, EmotionCaptureWelcomeActivity.class);
                intent.putExtra("quizData", (Serializable) faceQuiz);
                startActivity(intent);
            }
